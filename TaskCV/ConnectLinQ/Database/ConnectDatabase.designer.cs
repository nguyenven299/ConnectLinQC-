...
namespace ConnectLinQ.Database
{
    ...
    partial void Deletetodo(todo instance);
		...
		public ConnectDatabaseDataContext() : 
				base(global::ConnectLinQ.Properties.Settings.Default.DatabaseTestConnectionString1, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OnphotoUrlUserChanging(string value);
    partial void OnphotoUrlUserChanged();
    #endregion
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_photoUrlUser", DbType="Text", UpdateCheck=UpdateCheck.Never)]
		public string photoUrlUser
		{
			get
			{
				return this._photoUrlUser;
			}
			set
			{
				if ((this._photoUrlUser != value))
				{
					this.OnphotoUrlUserChanging(value);
					this.SendPropertyChanging();
					this._photoUrlUser = value;
					this.SendPropertyChanged("photoUrlUser");
					this.OnphotoUrlUserChanged();
				}
			}
		}
