...
namespace ConnectLinQ
{
    ...
    partial void InsertDemoLinQ(DemoLinQ instance);
    partial void UpdateDemoLinQ(DemoLinQ instance);
    partial void DeleteDemoLinQ(DemoLinQ instance);
    #endregion
		
		public DataLinqDataContext() : 
				base(global::ConnectLinQ.Properties.Settings.Default.DemoConnectionString2, mappingSource)
		{
			OnCreated();
		}
		...
		public System.Data.Linq.Table<DemoLinQ> DemoLinQs
		{
			get
			{
				return this.GetTable<DemoLinQ>();
			}
		}
	}
	
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.DemoLinQ")]
	public partial class DemoLinQ : INotifyPropertyChanging, INotifyPropertyChanged
	{
